'''
Code for prediction of deaths using MGUS 
Used 7 different ML algorithms and SVM is performing better than the other algorithms
'''
import numpy as np
import pandas as pd 
...
#Ignorind the warnings
warnings.filterwarnings('ignore')

#Calling the data from using panda and verifying
main_file=pd.read_csv('./doc/train_gammo.csv')
...
#Transforming Sex from male and female into numeric
le = LabelEncoder()
...
#main_file = main_file.drop("ptime",axis=1)
X = main_file.ix[:,0:8]
Y = main_file["death"]
seed = 10
